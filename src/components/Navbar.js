				    ...
				    <NavLink className="nav-link active text-center" aria-current="page" to="/home/"><i class="bi bi-house-fill"></i></NavLink>
			      	{
			      		auth.loggedIn ?
			        		...
			        		:
			        		<>
						     	<NavLink className="nav-link disabled" to="/tasks/"> <i class="bi bi-list-task"></i> 
                                            </NavLink>
				      			<NavLink className="nav-link disabled" to="/tasks/add/"> <i class="bi bi-plus-lg"></i>
                                        </NavLink>			        			
			        		</>
			      ...
			      <div className="navbar-nav ms-auto">
			      	{
			      		auth.loggedIn ?
			      			<>
						        ...
						        <NavLink className="nav-link text-danger" > {auth.user.role} </NavLink>
				        		<NavLink className="nav-link" onClick={logoutUser}> <i class="bi bi-box-arrow-in-right"></i></NavLink>
			        		</>
			        		:
			        		<>
						      	<NavLink className="nav-link" to="/login/"> <i class="bi bi-box-arrow-in-left"></i>
                                        </NavLink>
